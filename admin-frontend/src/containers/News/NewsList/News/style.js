...
const NewsListPageWrapper = styled.div`
  .PageHeader {
    width: 100%;
    display: -webkit-box;
    display: -webkit-flex;
  ...
  .PageContent {
    ...
    .NewsInformation {
      ...
      .FormContainer {
        ...
        &.NewsEditor {
          ...
          .quill {
            height: ${props => (props.isNews ? '500px' : '')};

            .ql-editor {
              max-height: ${props => (props.isNews ? '100%' : '')};
              height: 100%;
            }
    ...
    .RightSideContent_active .ant-form-item {
      display: flex;
      margin: 0;
    }
  }
...
export default WithDirection(NewsListPageWrapper);
