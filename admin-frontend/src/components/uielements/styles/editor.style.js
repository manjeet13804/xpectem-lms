...
const QuillEditor = styled.div`
  ...
  .ql-picker.ql-language .ql-picker-item::before, 
  .ql-picker.ql-language .ql-picker-label::before {
    content: 'Language';
    font-size: 12px;
    line-height: 16px;
  }

  .ql-picker.ql-language [data-value="1"]::before {
    content: 'English'
  }

  .ql-picker.ql-language [data-value="2"]::before {
    content: 'Norsk'
  }

    .ql-picker.ql-language [data-value="3"]::before {
      content: 'Svenska'
    }
