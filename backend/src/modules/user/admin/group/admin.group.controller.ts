...
import { createAdminGroupSchema } from '../joi/joi.validation'
...
@ApiBearerAuth()
@ApiUseTags('admin group administration')
@Controller('admin/admin-group')
export class AdminGroupController {
  ...
  @ApiOperation({ title: 'Create group administrator ' })
  @ApiResponse({
  ...
  @UsePipes(new JoiValidationPipe(createAdminGroupSchema))
  public async createUser(
    ...
    return this.adminGroupService.createAdmin(createData);
  }
  ...
  @ApiOperation({ title: 'Search group administrator' })
  @ApiResponse({
    description: 'Administrators found successfully. Get group administrators.',
    status: HttpStatus.OK,
    type: [User],
  })
  ...
  public async searchUser(
    ...
    return this.adminGroupService.searchAdmin(query, user);
  }
  ...
  @ApiOperation({ title: 'Get group administrator' })
  @ApiResponse({
  ...
  public async getUser(
    ...
    return this.adminGroupService.getAdminById(param, user);
  }
  ...
  @ApiOperation({ title: 'Update group administrator ' })
  @ApiResponse({
  ...
  public async updateUser(
    ...
    return this.adminGroupService.updateAdmin(id, updateData);
  }
  ...
  @ApiOperation({ title: 'Close group administrator account' })
  @ApiResponse({
    description: 'Close group administrator account',
    status: HttpStatus.OK,
  })
  @ApiNotFoundResponse({
  ...
  public async closeUserAccount(
    ...
    const { user } = requestData;
    const closeResult = await this.adminService.closeUserAccount(id, UserRole.ADMIN_GROUP, user);
  ...
  @ApiOperation({
    title: 'Import group administrator from file',
  ...
  @UsePipes(new JoiValidationPipe({
    ...
    groups: joi.array().items(joi.number().positive()).min(1).required(),
  }))
  public async  importUser(
    ...
    return this.adminGroupService.importAdmin(file, body, user);
  }
  ...
  @ApiOperation({ title: 'Download template for import group administrators' })
  @ApiResponse({
